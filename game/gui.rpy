...
define gui.choice_button_text_hover_color = "#d1cdcd"
define gui.choice_button_text_insensitive_color = '#4747477f'
...
define config.thumbnail_width = 631
define config.thumbnail_height = 355
